<div id="top" style="position: relative; height: 75px; border: 0;" >
    <div id="topbar" style="height: 35px;"  class="ui-widget-header">
        ...
        <div style="float: right; margin-right: 10px; margin-top: 10px;" class="ui-state-default ui-corner-all"><a href="<?php echo base_url('home'); ?>" class="ui-icon ui-icon-home"></a></div>
    </div>
    <?php
